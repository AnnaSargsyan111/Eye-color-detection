...
export default function OptionCard({ selected, onSelect, title, description, disabled }) {
  return (
    <button
      ...
      className={`flex w-full flex-col gap-1 rounded-card border bg-surface p-lg text-left transition-colors outline-none disabled:cursor-not-allowed disabled:opacity-40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#94A3B8] ${
